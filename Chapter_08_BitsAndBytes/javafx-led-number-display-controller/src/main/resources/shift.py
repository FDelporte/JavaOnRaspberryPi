...
# Use context managers to automatically close pins when done
with OutputDevice(PIN_DATA) as data_pin, \
        OutputDevice(PIN_SRCLK) as clock_pin, \
        OutputDevice(PIN_RCLK_LATCH) as latch_pin:
